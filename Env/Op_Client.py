...
class Client:
    ...
    def __init__(self, cfg):
        ...
        # Obstacles in the environment for Op
        self.object_ids = []
    # ----------------------------------------------------------------
    ...
    def load_object(
        ...
        obj_info = (object_id, obj_name, object_position)
        self.object_ids.append(obj_info)
    ...
    #  判断哪些物体是放在地面上
    def get_ground_truth(self, object_id, print_output=False): #TODO: use a polygon to represent the bounding box
        """
    ...
    def get_bounding_box_xyz(self, object_id, print_output=False):  # TODO: use a polygon to represent the bounding box
        """
        This function retrieves the bounding box for a given object in the PyBullet simulation environment.
